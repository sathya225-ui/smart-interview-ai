...
import { Clock, BarChart3, ArrowLeft, Trash2, Loader2 } from "lucide-react";
    ...
    <section className="min-h-screen px-6 py-12 max-w-3xl mx-auto">
      ...
      {sessions.length === 0 ? (
        ...
        >
          ...
          <Button onClick={() => navigate("/")} className="mt-4 glow">
            Start Interview
          </Button>
        </motion.div>
      ) : (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground flex items-center gap-1">
                    ...
                    {s.performance_label && (
                      <span className="ml-2 text-primary">· {s.performance_label}</span>
                    )}
                  </p>
                </div>
              </div>
